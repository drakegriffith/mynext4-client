...
import {
  MediumCareerCarousel,
  MediumCollegeCarousel,
  MediumCourseCarousel,
} from "./helpers/LikedComponentCarousel";
...
const Dashboard = () => {
  ...
  const { userID, username, setUserID, setUsername, token } =
  ...
  const tutorialSteps = [
    {
      target: ".step-1-tut",
      content:
        "Congratulation on completing the starter tutorial! It's time to do more with MyNext4. See your selected courses here.",
    },
    {
      target: ".step-2-tut",
    ...
    },
    {
      target: ".step-3-tut",
      content:
        "...and careers. All of your personalized information is put on this page.",
    },
    {
      target: ".step-4-tut",
      content:
        "Inspect your personal information here, click to turn on and off.",
    },
    {
      target: ".step-5-tut",
      content:
        "Complete more MyNext4 surveys here. Completing surveys help us write recommendations with higher correlation to you. ",
    },
    {
      target: ".step-6-tut",
    ...
    const checkTutorialCompletion = async () => {
      try {
        const response = await API.get(
          `/check-tutorial-complete/${userID}/`,
          config
        );
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        const [courseResponse, collegeResponse, careerResponse] =
          await Promise.all([
  ...
  const [openedAward, { open: openAward, close: closeAward }] =
    useDisclosure(false);
  const [openedSurvey, { open: openSurvey, close: closeSurvey }] =
    useDisclosure(false);
  const [openedSetting, { open: openSetting, close: closeSetting }] =
    useDisclosure(false);

  const DashboardMissions = () => {
    const [openedMission, { open: openMission, close: closeMission }] =
      useDisclosure(false);
    ...
    return (
      <div>
        ...
        >
          <h6
            className="animated-gradient-text h4Tag"
            style={{
              textAlign: "center",
              fontWeight: 800,
              fontSize: "40px",
  ...
  return isAuthenticated && userID ? (
    <div className="dashboard-container">
      ...
      <Modal opened={openedSetting} onClose={closeSetting} title="Settings">
        <h4 style={{ textAlign: "center", marginBottom: 5 }}>
          {" "}
          User {username}. Active session ID {userID}
        </h4>
        <p style={{ textAlign: "center" }}>
          MyNext4 LLC ⓒ. Established March 30, 2022. All copyrights reserved.
          Make your mark with MyNext4.
        </p>
        <Button
          style={{
            width: "150px",
        ...
        >
          ...
          <Collapse in={opened}>
            ...
            >
              ...
              <h5 style={{ marginTop: 5, fontSize: "16px", color: "white" }}>
                {" "}
                <Sparkles>MyMedals</Sparkles>
              </h5>

              <motion.div
                className="step-6-tut"
                animate={{ y: [-20, 0], opacity: [0, 1] }}
                whileHover={{ scale: 1.1 }}
                onClick={openSurvey}
                style={{
      ...
      <Paper
        ...
        style={{ marginTop: 10 }}
      >
        <div className="shiny-text" style={topDashboardStyle}>
          {username}
        </div>
        <div style={{ marginTop: 10 }}>
          <Tabs defaultValue="courses">
            ...
            >
              <Tabs.Tab
                value="courses"
                className="step-1 step-1-tut"
                style={{ color: "white" }}
                icon={<Book size="1.6rem" />}
              >
                <b>Courses</b>
              </Tabs.Tab>
              <Tabs.Tab
                value="colleges"
                className="step-2 step-2-tut"
                style={{ color: "white" }}
                icon={<School size="1.6rem" />}
              >
                <b>Colleges</b>
              </Tabs.Tab>
              <Tabs.Tab
                value="careers"
                className="step-3 step-3-tut"
                style={{ color: "white" }}
                icon={<ChefHat size="1.6rem" />}
              >
                <b>Careers</b>
              </Tabs.Tab>
            </Tabs.List>
            ...
            <Tabs.Panel value="courses" pt="xs">
              ...
              >
                ...
                >
                  <b>{courseLikedList.length}</b> Total Cards
                </div>
            ...
            <Tabs.Panel value="colleges" pt="xs">
              ...
              >
                ...
                >
                  <b>{collegeLikedList.length}</b> Total Cards
                </div>
                <div style={{ marginTop: 5 }}>
            ...
            <Tabs.Panel value="careers" pt="xs">
              ...
              >
                ...
                >
                  <b>{careerLikedList.length}</b> Total Cards
                </div>
                <div style={{ marginTop: 5 }}>
    ...
    >
      <h1>
        {" "}
        Your account has been unauthorized. Refresh your browser and sign in
        again.
      </h1>{" "}
    </div>
  );
