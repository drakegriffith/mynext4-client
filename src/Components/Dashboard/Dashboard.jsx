...
import { SmallCourse } from '../MyCourses/course';
import { SmallCollege } from '../MyColleges/College';
import { SmallCareer } from '../MyCareers/career';
...
<div className="ovr-container">
    ...
    <TopNav  />
        ...
        <PersonalSide  name={activeUser.username} email={activeUser.email} userID={userID} />
